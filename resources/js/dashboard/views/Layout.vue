                      ...
                      <div class="row">
                        <div class="col-10 col-md-offset-2">
                          <div class="form-group">
                            <div class="col-sm-8">
                              <colorpicker
                                :section_name="$t('labels.admin.layout.font')"
                        ...
                        <div class="col-10 col-md-offset-2">
                          <div class="form-group">
                            <div class="col-sm-8">
                              <colorpicker
                                :section_name="
                                  $t('labels.admin.layout.background')
                                "
                      ...
                      <div class="row">
                        <div class="col-10 col-md-offset-2">
                          <div class="form-group">
                            <div class="col-sm-8">
                              <colorpicker
                                :section_name="$t('labels.admin.layout.button')"
                    ...
                    <div class="col-md-6 col-md-offset-6">
                      <b-card no-body>
                        <div
                          class="container"
                          :style="{
                            background: model.settings.widgetBackground
                          }"
                        >
                          <p
                            class="module-donate__title"
                          ...
                          <div class="module-donate__wrapper">
                            ...
                            <div class="module-donate__main-panel">
                              <div class="module-donate__input">
                                <b-button
                                  v-for="button in fakeCampaign.button_values"
                                  class="module-donate__button-select"
                                  :key="button"
                                  :style="{
                                    background: model.settings.buttonBackground,
                                    color: model.settings.fontColor
                                  }"
                                >
                                  {{ button }} {{ fakeCampaign.currency }}
                                </b-button>
                                <input
                                  type="number"
                                  :style="{
                          ...
                          <b-progress
                            :style="{
                              background: model.settings.progressBarColor
                            }"
                            :value="fakeCampaign.amount_collected"
                            :max="fakeCampaign.target_amount"
                            class="progress__bar"
                          ></b-progress>
