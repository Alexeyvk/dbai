  ...
  <div>
    <div>
      <b-card no-body>
        <b-tabs pills card>
          <b-tab
            :title="$t('buttons.admin.notifications.header.onePay')"
            active
          >
            <b-card-text>
                ...
                <div v-if="notification.regular === 0">
                  <div>
                    ...
                    <b-tabs content-class="mt-3">
                      <b-tab
                        :title="$t('buttons.admin.notifications.description')"
                        active
                      >
...
export default {
  ...
  created() {
    axios
      .get(this.$app.route('dashboard.notifications.index'))
      .then(({ data }) => {
        //console.log(data);
  ...
  methods: {
    ...
    editForm(data) {
      axios
        .put(
          this.$app.route('dashboard.notifications.update', {
